...
-   **Task Completion Commits**: Every completed task must end with verified changes committed to git. Do not leave task-complete tracked changes uncommitted unless the user explicitly instructs otherwise.
